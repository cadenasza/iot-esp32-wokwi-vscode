...
// Identificadores
const char* ID        = "cp3Iot";
const char* moduleID  = "esp32Cp3";
...
// MQTT Broker
const char* BROKER_MQTT  = "4.201.202.90";
const int   BROKER_PORT  = 1883;
const char* mqttUser     = "cp3";
const char* mqttPassword = "cp3iot";

// Tópico MQTT
#define TOPICO_PUBLISH  "ESP32"
